...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form id="form_validation" action="{{ route('resep.store') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input type="number" class="form-control @error('jumlah_obat') is-invalid @enderror"
                                name="jumlah_obat" autocomplete="off" required value="{{ old('jumlah_obat') }}">
                        </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input type="text" class="form-control @error('dosis') is-invalid @enderror" name="dosis"
                                autocomplete="off" required value="{{ old('dosis') }}">
                        </div>
                        @if($errors->has('dosis'))
                        <span class="invalid-feedback" role="alert">
