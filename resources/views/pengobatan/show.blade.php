@extends('layout\app')
@section('title', 'Informasi Detail Data Pengobatan / Pemeriksaan')
...
<div class="container-fluid">
    ...
    <div class="block-header">
        <h2>Detail Informasi Pengobatan</h2>
    </div>
</div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <form action="{{ route('pengobatan.destroy', $pengobatan->id) }}" method="post">
                                ...
                                <a href="{{ route('pengobatan.index') }}" class="pull-right btn btn-primary btn-md">
