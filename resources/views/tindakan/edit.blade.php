...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form id="form_validation" action="{{ route('tindakan.update', $tindakan->id) }}" method="POST">
                    {{ csrf_field() }} {{ method_field('PUT') }}
                    <div class="form-group form-float">
                        <div class="form-line">
                            <label class="form-label" for="name">Nama</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                autocomplete="off" required value="{{ $tindakan->name }}">
                        </div>
                        @if($errors->has('name'))
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input type="number" class="form-control @error('harga') is-invalid @enderror" name="harga"
                                autocomplete="off" required value="{{ $tindakan->harga }}">
                        </div>
                        @if($errors->has('harga'))
                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <textarea name="description" cols="30" rows="5"
                                ...
                                required>{{ $tindakan->description }}</textarea>
                        </div>
