...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form id="form_validation" action="{{ route('pengobatan_detail.update', $pengobatan_detail->id) }}" method="POST">
                    {{ csrf_field() }} {{ method_field('PUT') }}
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="hidden" id="pengobatan_id" name="pengobatan_id" value="{{ $pengobatan_detail->pengobatan_id }}">
                            ...
                            <input type="text" class="form-control @error('pengobatan_id') is-invalid @enderror"
                                autocomplete="off" required value="{{ $pengobatan_detail->pengobatan->pasien->nama }}" disabled>
                        </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <textarea name="keterangan" cols="30" rows="5"
                                ...
                                required>{{ $pengobatan_detail->keterangan }}</textarea>
                        </div>
